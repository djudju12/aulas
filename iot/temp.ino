...
/*  
 * Itera no array de LEDS e escreve o resultado da operação binaria:
 * codigo_numero >> index_led 
 * basicamente iterando no codigo binario tb.
 * 
 * 0b1111011 >> 6 = 0b0000001
 * 0b0000001 & 1 = 1 
 * vai ser escrito 1 no led A        
 */
...
void loop()
{
   ...
   temp -= 100; // offset 500mV -> 00 0110 0100 -> 100 decimal
   temp /= 2;   // a cada 2bits -> temperatura++
   int unidade = temp % 10;
   int dezena = temp / 10;
