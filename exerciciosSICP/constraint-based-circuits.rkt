...
(define (adder a1 a2 sum)
   ...
   (define (process-forget-value)
      ...
      (forget-value! m1 me)
      (forget-value! m2 me)
      (process-new-value)) ; you have to do this because these values may need to be propagated through the adder
   (define (me request)
...
(define (multiplier m1 m2 product)
   ...
   (define (me request)
      (cond ((eq? request 'I-have-a-value)  (process-new-value))
            ((eq? request 'I-love-my-value) (process-forget-value))
